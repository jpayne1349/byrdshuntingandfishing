...
>
  <h3
    class="xl:absolute mt-4 mb-auto xl:mt-0 left-[3vw] xl:top-[55vh] xl:max-w-[50vh] text-white font-bold text-5xl xl:text-7xl 3xl:text-9xl border-none text-center tracking-tight leading-12"
  >
